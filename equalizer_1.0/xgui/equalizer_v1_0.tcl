...
proc update_PARAM_VALUE.DATA_CARRIERS { PARAM_VALUE.DATA_CARRIERS } {
	# Procedure called to update DATA_CARRIERS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DATA_CARRIERS { PARAM_VALUE.DATA_CARRIERS } {
	# Procedure called to validate DATA_CARRIERS
	return true
}
...
proc update_MODELPARAM_VALUE.DATA_CARRIERS { MODELPARAM_VALUE.DATA_CARRIERS PARAM_VALUE.DATA_CARRIERS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DATA_CARRIERS}] ${MODELPARAM_VALUE.DATA_CARRIERS}
}
