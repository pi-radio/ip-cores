...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "repeats"

}

proc update_PARAM_VALUE.repeats { PARAM_VALUE.repeats } {
	# Procedure called to update repeats when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.repeats { PARAM_VALUE.repeats } {
	# Procedure called to validate repeats
	return true
}
...
proc update_MODELPARAM_VALUE.repeats { MODELPARAM_VALUE.repeats PARAM_VALUE.repeats } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.repeats}] ${MODELPARAM_VALUE.repeats}
}
